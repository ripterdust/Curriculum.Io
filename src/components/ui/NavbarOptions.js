        ...
        <div className="left">
            ...
            <div className="categories">
                <Link className="cat" to='/templates/simple'>
                    <div className="title"><i class="lni lni-star"></i>Simple</div>
                ...
                <Link className="cat" to='/templates/pro'>
                    <div className="title"><i class="lni lni-briefcase"></i>Profesional</div>
                    <div className="description">
                ...
                <Link className="cat" to="/templates/modern" >
                    <div className="title"><i class="lni lni-rocket"></i>Modern</div>
                    <div className="description">
                ...
                <Link className="cat" to="/templates/creative" >
                    <div className="title"><i class="lni lni-brush-alt"></i>Creative</div>
                    <div className="description">
